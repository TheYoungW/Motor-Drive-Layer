...
class CanBus {
 public:
  ...
  // Wake a blocking receive without closing the transport. Controller uses
  // this to join its RX worker immediately during orderly shutdown.
  virtual void wake_receive() {}
